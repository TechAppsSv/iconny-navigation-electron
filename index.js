...
function Navigation(options) {
    ...
    if (options.showUrlBar) {
        $('#nav-body-ctrls').append('<input id="nav-ctrls-url"  style="width:1%;" type="text" title="Enter an address or search term"/>')
    }
...
Navigation.prototype.newTab = function (url, options) {
    ...
    // add webview    
    let composedWebviewTag = `<webview class="nav-views-view active" preload="../contextual.js" partition='persist:webviewsession'  useragent="Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.116 Safari/537.36 Edge/88.0.705.50  "
